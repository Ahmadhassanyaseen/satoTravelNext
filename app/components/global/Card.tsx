        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="relative h-60">
            ...
            <div className="absolute bottom-0 left-0 flex text-sm text-white w-full">
              ...
              <p className="flex-1 p-2 bg-black bg-opacity-50 flex items-center justify-center gap-2">
                <FontAwesomeIcon icon={faUsers} /> {vehicleDetails.passengerQuantity}
              </p>
            </div>
          </div>
          <div className="p-4 text-left">
            <div className="flex justify-between items-center mb-2">
              <div className="text-lg font-semibold text-black w-[60%]">{title}</div>
              <div className="flex items-center gap-2 text-gray-600">
                <FontAwesomeIcon icon={faCar} />
                <span className="text-sm">{vehicleDetails.name} ({vehicleDetails.type})</span>
              </div>
            </div>
