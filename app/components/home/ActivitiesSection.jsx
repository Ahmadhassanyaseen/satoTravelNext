  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 p-10">
        <div>
          <h1
            className="text-[4rem] md:text-[5rem] font-bold text-gray-100 mb-[-1.5rem] uppercase relative text-center md:text-right"
            data-aos="fade-up"
          ...
          <h2
            className="text-[20px] font-[500] text-gray-900 mb-4 text-center md:text-right"
            data-aos="fade-up"
            data-aos-duration="3000"
          >
        ...
        <div className="flex items-start justify-center gap-10 text-left mt-20">
          <div>
            <div className="mb-10">
              ...
              <h2
                className="text-2xl font-[600] text-gray-900 my-2"
                data-aos="fade-up"
              ...
              <p
                ...
                data-aos-duration="3000"
              >
                Lorem ipsum dolor sit amet, consectetur adi piscing elit, sedyo
                eiusmod tempor incididunt ut labore et dolore magnaour aliqua
                tenim.
              </p>
            </div>
            <div className="mb-10">
